...
public class Get16 extends DummyRestApiBaseUrl {
    ...
    */
    ...
    public void get16() {
        ...
        //  ii) There are 24 employees
        //  iii) "Tiger Nixon" and "Garrett Winters" are among the employees
        response .then().assertThat().body("data.employees",hasSize(24),"data.employee_name",hasItems("Tiger Nixon", "Garrett Winters"));
        ...
        // iv) The greatest age is 66
        System.out.println(ages.get(ages.size() - 1)); // en buyuk yası getirir.
        assertEquals(66,(int)(ages.get(ages.size()-1))); // dogruladık.
